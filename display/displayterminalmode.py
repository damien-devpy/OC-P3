'''
Contain class DisplayTerminalMode. Allow to display the game in the terminal
...
class DisplayTerminalMode:
    ...
    def _display_items(self, coordinates, items_positions):
        '''
        Display item key's dict that match actual coordinate
        in items_positions dict
        '''
        print(ITEMS_TO_PICKED[items_positions[coordinates]], end='')
